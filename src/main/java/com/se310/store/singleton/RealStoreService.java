...
import com.se310.store.model.Appliance;
import com.se310.store.model.ApplianceType;
...
import com.se310.store.model.Sensor;
import com.se310.store.model.SensorType;
...
import com.se310.store.proxy.StoreService;
 ...
 * @since 2025-09-25
 **/
public class RealStoreService implements StoreService {

    //TODO: Implement Thread Safe Double-Checked Locking Singleton Pattern
    private static volatile RealStoreService instance;

    public static RealStoreService getInstance() {
        if(instance == null) {
            synchronized (StoreService.class) {
                if(instance == null) {
                    instance = new RealStoreService();
                }
            }
        }
        return instance;
